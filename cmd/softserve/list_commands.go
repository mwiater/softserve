// cmd/softserve/list_commands.go
...
// It lists all available commands and subcommands of the goscaffold tool
...
by the goscaffold tool, with a clear and aligned output.`,
